...
<div class="box">
   ...
   <div class="cafe-container">
    <div class="cafe-section" id="cafe1" onclick="sign_up(1); toggleDescription(1);">
        <img src="images/temaFood1.jpeg" alt="카페 1" class="cafe-image">
        <p id="cafe1-text" style="margin-right: 200px;">한식 퓨전 요리</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe2" onclick="sign_up(2); toggleDescription(2);">
        <img src="images/temaFood2.jpeg" alt="카페 2" class="cafe-image">
        <p id="cafe2-text" style="margin-right: 200px;">아시아 음식 탐험</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe3" onclick="sign_up(3); toggleDescription(3);">
        <img src="images/temaFood3.jpeg" alt="카페 3" class="cafe-image">
        <p id="cafe3-text" style="margin-right: 200px;">차 마스터</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe4" onclick="sign_up(4); toggleDescription(4);">
        <img src="images/temaFood4.jpeg" alt="카페 4" class="cafe-image">
        <p id="cafe4-text" style="margin-right: 200px;">맛있는 비법 요리</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe5" onclick="sign_up(5); toggleDescription(5);">
        <img src="images/temaFood5.jpeg" alt="카페 5" class="cafe-image">
        <p id="cafe5-text" style="margin-right: 200px;">디저트 마스터</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe6" onclick="sign_up(6); toggleDescription(6);">
        <img src="images/temaFood6.jpeg" alt="카페 6" class="cafe-image">
        <p id="cafe6-text" style="margin-right: 200px;">베이킹 레슨</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe7" onclick="sign_up(7); toggleDescription(7);">
        <img src="images/temaFood7.jpeg" alt="카페 7" class="cafe-image">
        <p id="cafe7-text" style="margin-right: 200px;">양식 요리 입문</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe8" onclick="sign_up(8); toggleDescription(8);">
        <img src="images/temaFood8.jpeg" alt="카페 8" class="cafe-image">
        <p id="cafe8-text" style="margin-right: 200px;">건강한 채식 요리</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe9" onclick="sign_up(9); toggleDescription(9);">
        <img src="images/temaFood9.jpeg" alt="카페 9" class="cafe-image">
        <p id="cafe9-text" style="margin-right: 200px;">퓨전 디저트</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe10" onclick="sign_up(10); toggleDescription(10);">
        <img src="images/temaFood10.jpeg" alt="카페 10" class="cafe-image">
        <p id="cafe10-text" style="margin-right: 200px;">세계 음식 여행</p>
