...
<div class="box">
   ...
   <div class="cafe-container">
    <div class="cafe-section" id="cafe1" onclick="sign_up(1); toggleDescription(1);" >
        <img src="images/tema1.jpeg" alt="카페 1" class="cafe-image">
           <p id="cafe1-text" style="margin-right: 200px;">플라워 카페</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
   ...
   <div class="cafe-container">
    <div class="cafe-section" id="cafe2" onclick="sign_up(2); toggleDescription(2);">
        <img src="images/tema2.jpg" alt="카페 2" class="cafe-image">
           <p id="cafe2-text" style="margin-right: 200px;">게임 카페</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
  ...
  <div class="cafe-container">
        <div class="cafe-section" id="cafe3" onclick="sign_up(3); toggleDescription(3);">
            <img src="images/tema3.jpeg" alt="카페 3" class="cafe-image">
            <p id="cafe3-text" style="margin-right: 200px;">인형 카페</p>
 ...
 <div class="cafe-container">
    <div class="cafe-section" id="cafe4" onclick="sign_up(4); toggleDescription(4);">
        <img src="images/tema4.jpeg" alt="카페 4" class="cafe-image">
        <p id="cafe4-text" style="margin-right: 200px;">빈티지 카페</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe5" onclick="sign_up(5); toggleDescription(5);">
        <img src="images/tema5.jpeg" alt="카페 5" class="cafe-image">
        <p id="cafe5-text" style="margin-right: 200px;">북카페</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe6" onclick="sign_up(6); toggleDescription(6);">
        <img src="images/tema6.jpeg" alt="카페 6" class="cafe-image">
        <p id="cafe6-text" style="margin-right: 200px;">고양이 카페</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe7" onclick="sign_up(7); toggleDescription(7);">
        <img src="images/tema7.png" alt="카페 7" class="cafe-image">
        <p id="cafe7-text" style="margin-right: 200px;">로봇 카페</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe8" onclick="sign_up(8); toggleDescription(8);">
        <img src="images/tema8.jpeg" alt="카페 8" class="cafe-image">
        <p id="cafe8-text" style="margin-right: 200px;">어반 가든 카페</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe9" onclick="sign_up(9); toggleDescription(9);">
        <img src="images/tema9.jpeg" alt="카페 9" class="cafe-image">
        <p id="cafe9-text" style="margin-right: 200px;">뮤지엄 카페</p>
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe10" onclick="sign_up(10); toggleDescription(10);">
        <img src="images/tema10.jpeg" alt="카페 10" class="cafe-image">
        <p id="cafe10-text" style="margin-right: 200px;">해변 카페</p>
