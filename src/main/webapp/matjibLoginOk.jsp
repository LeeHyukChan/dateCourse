...
<body>
		   ...
		   <nav class="navbar" role="navigation" aria-label="main navigation">
	        ...
	        <div id="navbarBasicExample" class="navbar-menu">
	            <div class="navbar-start">
	                <a href="placeList2.jsp?name=<%= name %>" class="navbar-item">
	                    맛집 찾기
	                </a>
	...
	<hr>
	<a href="follow?name=<%=name%>">다른 유저를 팔로우하고 데이트 코스 공유 !</a>
	<br><br>
	<a href="service02.jsp?name=<%=name%>">나만의 데이트 코스 만들기 ! </a>
	<br><br>
	<a href="service03.jsp?name=<%=name%>">현재 유행하는 전시확인 !</a>
	<br><br>
	<a href="isack.jsp?name=<%=name%>"> 이색 데이트코스 ! </a>
	<br><br>
	<a href="review.jsp?name=<%=name%>">후기 & 리뷰 </a>
	<br>
	<br><br><br><br>
