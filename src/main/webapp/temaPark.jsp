...
<div class="cafe-container">
    <div class="cafe-section" id="cafe1" onclick="sign_up(1); toggleDescription(1);">
        <img src="images/temaPark1.jpeg" alt="카페 1" class="cafe-image">
        <p id="cafe1-text" style="margin-right: 200px;">에버랜드</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe2" onclick="sign_up(2); toggleDescription(2);">
        <img src="images/temaPark2.jpeg" alt="카페 2" class="cafe-image">
        <p id="cafe2-text" style="margin-right: 200px;">서울랜드</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe3" onclick="sign_up(3); toggleDescription(3);">
        <img src="images/temaPark3.jpeg" alt="카페 3" class="cafe-image">
        <p id="cafe3-text" style="margin-right: 200px;">서울 서부 화랑로 가로수길</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe4" onclick="sign_up(4); toggleDescription(4);">
        <img src="images/temaPark4.jpeg" alt="카페 4" class="cafe-image">
        <p id="cafe4-text" style="margin-right: 200px;">안산 와우정사</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe5" onclick="sign_up(5); toggleDescription(5);">
        <img src="images/temaPark5.jpeg" alt="카페 5" class="cafe-image">
        <p id="cafe5-text" style="margin-right: 200px;">롯데월드</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe6" onclick="sign_up(6); toggleDescription(6);">
        <img src="images/temaPark6.jpeg" alt="카페 6" class="cafe-image">
        <p id="cafe6-text" style="margin-right: 200px;">경기 월드 캘리포니아 비치</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe7" onclick="sign_up(7); toggleDescription(7);">
        <img src="images/temaPark7.jpeg" alt="카페 7" class="cafe-image">
        <p id="cafe7-text" style="margin-right: 200px;">헤이리예술마을</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe8" onclick="sign_up(8); toggleDescription(8);">
        <img src="images/temaPark8.jpeg" alt="카페 8" class="cafe-image">
        <p id="cafe8-text" style="margin-right: 200px;">송파파크하비오</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe9" onclick="sign_up(9); toggleDescription(9);">
        <img src="images/temaPark9.jpeg" alt="카페 9" class="cafe-image">
        <p id="cafe9-text" style="margin-right: 200px;">안산 임진각</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
...
<div class="cafe-container">
    <div class="cafe-section" id="cafe10" onclick="sign_up(10); toggleDescription(10);">
        <img src="images/temaPark10.jpeg" alt="카페 10" class="cafe-image">
        <p id="cafe10-text" style="margin-right: 200px;">관악산 둘레길</p> <!-- 이미지를 클릭하기 전에 보이는 텍스트 -->
